...
cells = [
    ...
    create_code_cell([
        ...
        "!pip uninstall -y transformers torch torchaudio tortoise-tts\n",
        "\n",
        "# Install specific versions of PyTorch\n",
        "!pip install --quiet torch==2.0.1 torchaudio==2.0.2\n",
        "\n",
        "# Install transformers from a specific commit known to work with Tortoise\n",
        "!pip install --quiet git+https://github.com/huggingface/transformers.git@v4.19.0\n",
        "\n",
        "# Install other dependencies\n",
        "!pip install --quiet numpy==1.24.3 librosa==0.10.1\n",
        "!pip install --quiet unidecode==1.3.6 inflect==7.0.0 tqdm==4.65.0\n",
        "\n",
        "# Install Tortoise TTS from a specific commit known to work\n",
