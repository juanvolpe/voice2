...
cells = [
    ...
    create_code_cell([
        ...
        "    !pip uninstall -y torch torchaudio torchvision transformers numpy tokenizers tortoise-tts huggingface-hub accelerate\n",
        ...
        "    \n",
        "    # Install base dependencies in correct order\n",
        "    !pip install --quiet numpy==2.0.0\n",
        "    !pip install --quiet huggingface-hub==0.28.1\n",
        "    !pip install --quiet tokenizers==0.15.0\n",
        ...
        "    \n",
        "    # Install Tortoise TTS with specific dependencies\n",
        "    !pip install --quiet git+https://github.com/neonbjb/tortoise-tts.git@4c1c4813e72f5e6f7c7d2a6f54d5f6b3d8e99b82\n",
        ...
        "    print(f\"Hugging Face Hub: {HfApi().version}\")\n",
        "    \n",
        ...
        "    else:\n",
        "        print(\"⚠️ CUDA not available. Please check GPU runtime settings.\")\n",
        "    \n",
        ...
        "print(\"\\n⚠️ Restarting runtime to apply changes...\")\n",
        "import os\n",
        "os.kill(os.getpid(), 9)\n",
        "\n",
